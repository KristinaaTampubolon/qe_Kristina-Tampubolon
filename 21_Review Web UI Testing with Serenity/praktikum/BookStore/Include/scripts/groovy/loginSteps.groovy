...
class loginSteps {
	...
	def enterCredentials(String userName, String password) {
		...
		WebUI.setText(findTestObject('Object Repository/Page_ToolsQA/input_UserName_userName'), userName)

		WebUI.setEncryptedText(findTestObject('Object Repository/Page_ToolsQA/input_Password_password'), password)
	}
